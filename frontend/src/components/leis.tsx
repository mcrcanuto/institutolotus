...
Com esse episódio, houve um grande debate acerca de segurança no espaço virtual, o que motivou a criação da 
Lei Nº 12.737/2012, também chamada de Lei Carolina Dieckman. Esse dispositivo legal alterou o Código Penal Brasileiro, 
sendo uma das primeiras bases legais para o Direito Digital, que ainda está em processo de formação.
Assim, foi criado o crime de invasão de dispositivos com o objetivo de obter, adulterar, destruir ou 
compartilhar publicamente dados sem autorização do proprietário. Apesar de ser uma lei que defende igualmente homens 
e mulheres, casos de fotos de mulheres vazados para a mídia são reconhecidamente mais frequentes.
...
para realizar a denúncia a partir do momento que completam 18 de anos de idade. Aumentando assim, a janela de tempo 
para que as famílias e vítimas possam buscar justiça.Assim como a Lei Carolina Dieckman, a Lei Joanna Maranhão foi 
nomeada em homenagem à uma mulher brasileira. Joanna, atleta e ativista, batalhou na justiça para obter um julgamento 
justo para o seu agressor, que na época, por conta das antigas leis, já tinha seus crimes prescritos.
</p>
</div>
</div>
</div>
...
às delegacias especializadas com informações que possam ser úteis à identificação do agressor e à comprovação 
da violência sexual;
<br></br>IV – profilaxia da gravidez;
<br></br>V – profilaxia das Doenças Sexualmente Transmissíveis – DST;
<br></br>VI – coleta de material para realização do exame de HIV para posterior acompanhamento e terapia;
<br></br>VII – fornecimento de informações às vítimas sobre os direitos legais e sobre todos os serviços sanitários disponíveis.
</p>
</div>
</div>
</div>
