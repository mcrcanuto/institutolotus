...
// node_modules/react-sweetalert2/build/index.module.js
...
var useForceRerendering = function() {
  var _a = (0, import_react.useState)(false), rerender = _a[0], setRerender = _a[1];
  return function() {
...
var withSwal = function(Component) {
  return import_react.default.forwardRef(function(props, ref) {
    return import_react.default.createElement(Component, __assign({ ref, swal: import_sweetalert2.default }, props));
  });
};
function SweetAlert2(props) {
  ...
  (0, import_react.useEffect)(function() {
    if (props.show && props.showLoading) {
      ...
      import_sweetalert2.default.hideLoading();
    }
  }, [props.showLoading]);
  (0, import_react.useEffect)(function() {
    var swalContainer2 = import_sweetalert2.default.getHtmlContainer();
    if (swalContainer2) {
      var showContainer = props.text || props.html || props.children;
      swalContainer2.style.display = showContainer ? "block" : "none";
    }
  }, [props.text, props.html, props.children]);
  function mountSwal() {
    props.show;
    props.showLoading;
    var onConfirm = props.onConfirm, willOpen = props.willOpen, onResolve = props.onResolve, onError = props.onError;
    props.children;
    var rest = __rest(props, ["show", "showLoading", "onConfirm", "willOpen", "onResolve", "onError", "children"]);
    rest["willOpen"] = function(el) {
      forceRerendering();
      willOpen && willOpen(el);
    };
    import_sweetalert2.default.fire(rest).then(function(result) {
  ...
  var swalContainer = import_sweetalert2.default.getHtmlContainer();
  if (swalContainer && !props.html) {
    return import_react_dom.default.createPortal(props.children, swalContainer);
  }
  return import_react.default.createElement(import_react.default.Fragment, null);
}
export {
  SweetAlert2 as default,
  withSwal
};
...
react-sweetalert2/build/index.module.js:
  (*! *****************************************************************************
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=react-sweetalert2.js.map
